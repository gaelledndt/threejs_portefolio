    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "contact@gaelledndtportefolio.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Je vous remercie. Je vous recontacte dès que possible");
        ...
        (error) => {
          ...
          alert("Ahh, une erreur est intervenue. Veuillez réessayez !");
        }
      );
  };
